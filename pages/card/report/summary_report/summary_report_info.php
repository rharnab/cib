                                    ...
                                    <table id="example" class="table table-bordered table-striped table-hover table-responsive">
                                        ...
                                        <tbody>
                                           ...
                                           <tr>
                                                ...
                                                <td><?php  echo date('M-Y', strtotime($summary_data_card_close['reporting_date']."+1 month")); ?></td>
