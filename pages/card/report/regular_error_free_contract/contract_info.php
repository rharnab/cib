        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>Contract Error Free Report (<?php echo date('m-Y', strtotime($_GET['frm'])); ?>) </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Report</a></li>
                        <li class="active">Contract Error Free Report</li>
                    </ol>
                </section>
            ...
            $sql =mysql_query(" SELECT * from contracts_info where status='1' " );
