        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>Subject Error Free  Report (<?php echo date('m-Y', strtotime($_GET['frm'])); ?>)</h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">CIB</a></li>
                        <li class="active">Subject Error Free</li>
                    </ol>
                </section>
          ...
          $sql =mysql_query("SELECT * from subject_info  where  status='1'  ");
