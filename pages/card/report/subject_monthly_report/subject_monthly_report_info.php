...
<style type="text/css">
  ...
  border: 1px solid red !important;
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
          ...
          $sql =mysql_query("SELECT *, record_type AS rec1 from subject_info  where fi_subject_code in  (select fi_subject_code from contracts_info  where  month(reporting_date)='$month' and year(reporting_date)='$year' group by fi_subject_code) 
            and status ='1' and  month(reporting_date)='$month' and year(reporting_date)='$year' ");
          ...
          {
              $sql =mysql_query("SELECT *, record_type AS rec1 from subject_info_archive where fi_subject_code in (select fi_subject_code from contracts_info_archive where month(reporting_date)='$month' and year(reporting_date)='$year' group by fi_subject_code order by count desc ) and status ='1' and month(reporting_date)='$month' and year(reporting_date)='$year'  order by count desc  ");
