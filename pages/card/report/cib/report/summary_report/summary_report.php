       ...
       <script src="../../../../js/jquery.min.js"></script>
        ...
        <script type="text/javascript">
            ...
            function generateReport()
		    {
		      ...
		      popupwindow = window.open("/CIB/pages/card/report/summary_report/summary_report_info.php?month_year="+document.info.frm.value+, 'newWindow', 'top=200, width=800, height=500, left=500, scrollbars=1, toolbar=no, resizable=false');
