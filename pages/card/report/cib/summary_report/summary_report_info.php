                                          ...
                                          <tr>
                                                ...
                                                <td>
                                                     ...
                                                     <?php
                                                       ...
                                                       $summary_query_card_close = mysql_query("SELECT count(ci.id) as total_close_card, reporting_date FROM `contracts_info` ci inner join card_close cl on ci.fi_contract_code = cl.card_no   ");
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                     ...
                                                     <?php
                                                       ...
                                                       $summary_query = mysql_query("SELECT count(ci.id) as total_close_card , reporting_date FROM `contracts_info` ci    where ci.status='0' ");
                                                ...
                                                <td><?php echo  $summary_data['reporting_date']; ?></td>
