                        ...
                        <div class="col-xs-4">
                            <div class="box">
                                <div class="box-body">
                                     ...
                                     <div class="tile-body">
                                      <form id="defaultForm" class="form-horizontal" name="info" action="card_close_report_info.php" method="GET" enctype="multipart/form-data" target="_blank">
	                                      ...
	                                      <div class="form-group row" style="margin-top: 10px;">
	                                        <div class="col-md-10">
	                                          <select name="rpt_sts" class="form-control" id="rpt_sts">
	                                           
	                                          <option value="">ALL</option>
	                                           <option value="1">Report</option>
	                                           <option value="0">Not Report</option>
	                                          </select>
	                                        </div>
	                                      </div>
       ...
       <script src="../../../../js/jquery.min.js"></script>
        ...
        <script type="text/javascript">
            ...
            function generateReport()
		    {
		      ...
		      popupwindow = window.open("/CIB/pages/card/report/cib/card_close_report_info.php?rpt_sts="+rpt_sts+'&frm='+document.info.frm.value+'&to='+document.info.to.value, 'newWindow', 'top=200, width=800, height=500, left=500, scrollbars=1, toolbar=no, resizable=false');
