...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Card | Import Close Card</title>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>Close Card  File Upload</h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">CIB Report</a></li>
                        <li class="active">Close Card file</li>
                    </ol>
                </section>
                            ...
                            <div class="box">
                               <div class="box-header">
                                ...
                                <div class="box-body">
                                  <!-- from -->
                                   <div class="tile-body">
                                      <form id="defaultForm" class="form-horizontal" name="info" action="save_card_close.php" method="post" enctype="multipart/form-data">
        ...
        var formData = new FormData(form);
          ...
          if(filePath !='')
          {
            ...
            if(allowedExtensions.exec(filePath) || allowedExtensions_2.exec(filePath))
            {
                ...
                swal({
                  title: "DO YOU WANT TO IMPORT THIS CARD CLOSE FILE ?? ",
                  icon: "success",
                  buttons: true,
                  dangerMode: true,
                })
