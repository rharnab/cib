        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side" style="margin-left: 0px !important;">                
                ...
                <section class="content-header">
                    <h1>Contract  Error [<?php echo $error_code ?>] </h1>
                            ...
                            <div class="box">
                                ...
                                if($error_code == 606)
                                {
                                    $query1 = $query;
                                     ...
                                     $query1="SELECT * FROM contracts_info WHERE $condition";
                                }
                                  ...
                                  <table class="table table-bordered userlistTable" style="font-size: 12px">
                                        ...
                                        <tbody>
                                          ...
                                          while( $result = mysql_fetch_array($sql))
                                          {
                                             ...
                                             $card_fi_sub = $result['card_fi_sub'];
                                             $fi_contract_code = $result['fi_contract_code'];
                                             $id= $result['id'];
                                            ...
                                            <tr>
                                              ...
                                              <td><?php  echo $card_fi_sub ?></td>
                                              <td><?php  echo $fi_contract_code ?></td>
...
function statusUpdate(id, status)
{
  ...
  if(id !='')
  {
      ...
      $.ajax({
        type:'post',
        url:'stop_contract_reporting.php',
