...
$sql =mysql_query("SELECT * from subject_info_archive  where year (reporting_date) ='$acc_year' and month (reporting_date)='$acc_month' ORDER BY entry_date desc limit 1 ");
