...
<?php 
	...
	$sql =mysql_query("SELECT * from contracts_info_archive si where year (reporting_date) ='$acc_year' and month (reporting_date)='$acc_month' group by count order by count asc ");
