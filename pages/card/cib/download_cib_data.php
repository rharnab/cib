...
$q=mysql_query(" SELECT *, record_type AS rec1 from subject_info  where fi_subject_code in (select fi_subject_code from contracts_info group by fi_subject_code) and status ='1' ");
...
$q=mysql_query(" SELECT *, record_type AS rec2 from contracts_info where status ='1' and fi_subject_code in (select fi_subject_code from subject_info where status ='1' or status ='2' group by fi_subject_code) ");
