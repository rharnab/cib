        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>Contract Monthly Report (<?php echo $frm; ?>)</h1>
                    <ol class="breadcrumb">
            ...
            $sql =mysql_query(" SELECT *, record_type AS rec2 from contracts_info where month(reporting_date)='$month' and year(reporting_date)='$year' and status ='1' and fi_subject_code in (select fi_subject_code from subject_info where status ='1' or status ='2' group by fi_subject_code)");

             if(mysql_num_rows($sql) == 0)
            {
                $sql =mysql_query(" SELECT *, record_type AS rec2 from contracts_info_archive where month(reporting_date)='$month' and year(reporting_date)='$year' and status ='1' and fi_subject_code in (select fi_subject_code from subject_info_archive where status ='1' or status ='2' group by fi_subject_code)");
