                        ...
                        <div class="col-xs-4">
                            <div class="box">
                                <div class="box-body">
                                     ...
                                     <div class="tile-body">
                                      <form id="defaultForm" class="form-horizontal" name="info" action="contract_monthly_report_info.php" method="GET" enctype="multipart/form-data" target="_blank">
